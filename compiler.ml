...
let make_prologue consts_tbl fvars_tbl =
  ...
  [
    ...
    "numerator", "numerator"; "denominator", "denominator"; "gcd", "gcd"; "cons", "cons"; "car", "car"; "cdr", "cdr";
    "set-car!", "set_car"; "set-cdr!", "set_cdr"; "apply", "apply"
...
try
  ...
  (* TODO: dont forget in the end to replace between the lines 137, 138 *)
